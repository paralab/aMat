...
>mpirun -np p ./example01 n m b s outputFile
...
>mpirun -np p ./example02 nx ny m b s outputFile
...
>mpirun -np p ./example03 nx ny nz m b s outputFile
...
>mpirun -np p ./example04 m b s meshFile outputFile
...
## example05
Same problem as example04, but using unstructured mesh of quadratic 10-node tetrahedra elements generated by Gmsh. Samples of Gmsh-generated mesh files for this example are in examples/Gmsh.
...
To run the example
>mpirun -np p ./example06 nx ny nz m b s outputFile
...
>mpirun -np p ./example07 nx ny nz m b s outputFile
## example08
...
To run the example
>mpirun -np p ./example08 m b s meshFile outputFile
